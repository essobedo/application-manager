...
public class TestDefaultApplicationManager {
    ...
    private File getRootFolder(String folderName) throws URISyntaxException {
        return new File(new File(TestDefaultApplicationManager.class.getResource("/").toURI()), folderName);
    }
    ...
    public void testAppUpgrade() throws Exception {
        ...
        try {
            ...
            assertTrue(applicationManager.checkForUpdate().execute());
            manager.doUpgrade();
        } finally {
