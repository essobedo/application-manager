 ...
 * @since 1.0
 */
public class Foo3VersionManager implements VersionManager<Foo3> {
    @Override
    public Task<String> check(final Foo3 application) throws ApplicationException {
        return new Task<String>("Check") {
            ...
            public String execute() throws ApplicationException {
                try {
                    if (new File(new File(Foo3VersionManager.class.getResource("/").toURI()),
    ...
    @Override
    public Task<Void> store(final Foo3 application, final OutputStream target) throws ApplicationException {
            ...
            public Void execute() throws ApplicationException {
                ...
                try (final BufferedOutputStream bos = new BufferedOutputStream(target);
                     final InputStream inputStream = new FileInputStream(
                         new File(new File(Foo3VersionManager.class.getResource("/").toURI()),
